...
#define SensorMessage_init_default               {0, 0, 0, 0, 0, 0, 0, 0}
#define SensorMessage_init_zero                  {0, 0, 0, 0, 0, 0, 0, 0}
...
extern const pb_field_t SensorMessage_fields[9];

/* Maximum encoded size of messages (where known) */
#define SensorMessage_size                       47
